var SSA = require('./support/neo4j-ssa'),
    ...
    neo4jFormatter = require('./support/neo4j-formatter');
...
function bindNeo4j(opts) {
    ...
    var c = opts.c,
        ...
        nc = new Neo4jCommon(c, h, httpPost),
        ssa = new SSA(h),
  ...
  var doc = neo4jDoc.bindNeo4jDoc(_.assign(opts, {dbClient:dbClient}));
  var tags = neo4jTags.bindNeo4jTags(_.assign(opts, {
    dbClient: dbClient,
    neo4jDoc: doc,
    neo4jFormatter: neo4jFormatter.bindNeo4jFormatter()
  }));
