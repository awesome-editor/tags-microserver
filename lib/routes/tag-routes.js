function bindRoutes(opts) {
    ...
    var router = express.Router(),
        ...
        naiveSuggestedTagCloud = function(req, res) {

            db.naiveSuggestedTagCloud(req.body).apply(function(data) {
...
*/
    ...
    router.post('/cloud/raw-suggested', rawSuggestedTagCloud);
    router.post('/cloud/suggested', naiveSuggestedTagCloud);
    router.post('/ssa', SSA);
