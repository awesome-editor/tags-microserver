 ...
 * @constructor
 */
function SSARecommendationEngine(_) {

    this.findKNearestNeighbors = findKNearestNeighbors;
    this.SSAp = SSAp;
    ...
    function findKNearestNeighbors(args) {
        ...
        var k = args.k,
            ...
            sorted = _.sortBy(categories, function(neighbor) {
    ...
    function SSAp(args) {
        ...
        var parameters = {
            ...
            denom = 1 / _sum(nearestneighbors, function(neighbor) {
        ...
        return _.chain(categories)
            .map(function(neighbor) {
                ...
                var ssa = denom * _sum(nearestneighbors, function(nearestNeighbor) {
    ...
    function _sum(_set, term) {

        return _.reduce(_set, function(memo, cur) {
...
module.exports = SSARecommendationEngine;